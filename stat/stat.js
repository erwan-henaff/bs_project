...
exports.task001 = new CronJob('0 0 12,20 * * *', addBattlesHighRank, null, true, 'Europe/Berlin');
...
exports.task004b = new CronJob('0 32 20 * * *', cleaningLowLevelHighRank, null, true, 'Europe/Berlin');

exports.task005 = new CronJob('0 11 12 * * *', brawlersRanking, null, true, 'Europe/Berlin');
exports.task005b = new CronJob('0 4 21 * * *', brawlerRanking_200BestPlayers, null, true, 'Europe/Berlin');
...
exports.task009 = new CronJob('0 40 20 * * *', brawlersPickWinRate200glob, null, true, 'Europe/Berlin');
exports.task010 = new CronJob('0 30 21 * * *', brawlersPickWinRate200duo, null, true, 'Europe/Berlin');
exports.task011 = new CronJob('0 21 21 * * *', brawlersPickWinRate200gemGrab, null, true, 'Europe/Berlin');
exports.task012 = new CronJob('0 27 21 * * *', brawlersPickWinRate200heist, null, true, 'Europe/Berlin');
exports.task013 = new CronJob('0 23 21 * * *', brawlersPickWinRate200bounty, null, true, 'Europe/Berlin');
exports.task014 = new CronJob('0 25 21 * * *', brawlersPickWinRate200siege, null, true, 'Europe/Berlin');
exports.task015 = new CronJob('0 19 21 * * *', brawlersPickWinRate200brawlBall, null, true, 'Europe/Berlin');
